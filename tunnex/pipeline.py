...
from tunnex_2.core.intepolated_irc import build_interpolated_irc  # type: ignore
...
def run_pipeline(params, potential):
    ...
    interpolated_irc_grid = build_interpolated_irc(
        potential.irc_x_min, potential.irc_x_max, potential, grid_size
    )
